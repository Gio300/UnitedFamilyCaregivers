          ...
          <div className="flex items-center gap-2">
            ...
            {tab === "messages" && (
              <button
                ...
                className="ml-1 p-1.5 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-zinc-800 border border-slate-200 dark:border-zinc-600"
                title="New message"
