...
-- Run AFTER seed_test_minimal.sql (requires client_profiles for Alice)
-- Use for testing Message Center (bell icon) UI

-- Sent messages (outbound emails) - requires client_id from client_profiles
...
-- Activity log (for caregivers/admins)
